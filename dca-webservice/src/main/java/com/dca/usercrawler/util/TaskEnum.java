...
public enum TaskEnum {
	PROVIDENT_FUND("provident_fund", "com.dca.usercrawler.util.ProvidentFundFactory", "公积金",
			"fund"), SOCIAL_INSURANCE("social_insurance", "com.dca.usercrawler.util.SocialInsuranceFactory", "社会保险", "social"),
	E_COMMERCE("e_commerce", "com.dca.usercrawler.util.EcommerceFactory", "电商", "ecommerce");
